...
jQuery(window).load(function () {
  ...
  jQuery("section.works ul li a").click(function () {
    ...
    jQuery("html, body").animate(
      { scrollTop: getCurrentPortTop.top },
      500,
      function () {
        if (jQuery("section.works article.work.slided").length > 0) {
          jQuery("section.works article.work.slided")
            .slideUp()
            .removeClass("slided");
  ...
  function banner() {
    ...
    if (jQuery("section.about .slider img").length > 1) {
      ...
      jQuery("section.about .sliderHolder .bannerNav a").css({
        display: "none",
      });
    }
  }
  ...
  function testimonialsSlider() {
    ...
    if (testimonialsSlider.find("article").length > 1) {
      ...
      var testimonialSliderWidth = testimonialsSlider
        .find("article")
        .eq(0)
        .width();
      var testimonialSliderHeight = testimonialsSlider
        .find("article")
        .eq(0)
        .height();
  ...
  function memberSlider() {
    ...
    if (jQuery("section.team .slider .sliderholder .member").length > 0) {
      ...
      jQuery("section.team .slider .sliderholder .member").css({
        width: "auto",
        height: "auto",
      });

      var memberSliderWidth = jQuery(
        "section.team .slider .sliderholder .member"
      )
        .eq(0)
        .width();
      var memberSliderHeight = jQuery(
        "section.team .slider .sliderholder .member"
      )
        .eq(0)
        .height();
