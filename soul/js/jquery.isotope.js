...
(function (window, $, undefined) {
      ...
      if (test) {
        var vendorCSSPrefixes = " -o- -moz- -ms- -webkit- -khtml- ".split(" "),
          mediaQuery =
            ...
            "modernizr)",
          $style = $(
            "<style>" + mediaQuery + "{#modernizr{height:3px}}" + "</style>"
          ).appendTo("head"),
    ...
    var transformFnNotations = Modernizr.csstransforms3d
      ? {
          ...
          translate: function (position) {
            return (
              "translate3d(" + position[0] + "px, " + position[1] + "px, 0) "
            );
          },
  ...
  $.Isotope.prototype = {
    ...
    _create: function (options) {
      ...
      this.options.getSortData = $.extend(
    ...
    _updateAnimationEngine: function () {
      var animationEngine = this.options.animationEngine
        .toLowerCase()
        .replace(/[ _\-]/g, "");
    ...
    _updateUsingTransforms: function () {
      ...
      this.getPositionStyles = usingTransforms
        ? this._translate
        : this._positionAbs;
    },
